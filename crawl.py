...
# 五类通选是已经显示的flag，1为否
display_flag_recommend = 1
display_flag_humanity = 1
display_flag_science = 1
display_flag_economics = 1
display_flag_sports = 1
...
class LoginDialog(Toplevel):
    ...
    def do_post(self, step):
        ...
        global list_sports
        global display_flag_recommend
        global display_flag_economics
        global display_flag_humanity
        global display_flag_science
        global display_flag_sports
        if step == 1:
            print("正在进行第一步：登录")
            global cookie
            global username
            ...
            url = "http://newxk.urp.seu.edu.cn/xsxkapp/sys/xsxkapp/student/check/login.do?" + "timestrap=" + str(
                int(time.time())) + "&loginName=" + str(
                username) + "&loginPwd=" + password + "&verifyCode=" + vercode + "&vtoken=" + vtoken
            ...
            login_token = jsonObject['data']['token']
            Msg = jsonObject['msg']
            print(login_token)
            print(Msg)
            if Msg != "登录成功":
        ...
        if step == 2:
            ...
            if display_flag_recommend == 1:
                root.event_generate("<<UPDATE_INSTITUTE_LIST>>")
                display_flag_recommend = 0
        ...
        if step == 3:
            ...
            header3.setdefault('Referer',
                               'http://newxk.urp.seu.edu.cn/xsxkapp/sys/xsxkapp/*default/grablessons.do?token=' + str(
                                   login_token))
            header3.setdefault('token', login_token)
            ...
            if display_flag_humanity == 1:
                root.event_generate("<<UPDATE_HUMANITY_LIST>>")
                display_flag_humanity = 0
        ...
        if step == 4:
            ...
            header4.setdefault('Referer',
                               'http://newxk.urp.seu.edu.cn/xsxkapp/sys/xsxkapp/*default/grablessons.do?token=' + str(
                                   login_token))
            header4.setdefault('token', login_token)
            ...
            if display_flag_science == 1:
                root.event_generate("<<UPDATE_SCIENCE_LIST>>")
                display_flag_science = 0
        ...
        if step == 5:
            ...
            header5.setdefault('Referer',
                               'http://newxk.urp.seu.edu.cn/xsxkapp/sys/xsxkapp/*default/grablessons.do?token=' + str(
                                   login_token))
            header5.setdefault('token', login_token)
            ...
            if display_flag_economics == 1:
                root.event_generate("<<UPDATE_ECONOMICS_LIST>>")
                display_flag_economics = 0
        ...
        if step == 6:
            ...
            header6.setdefault('Referer',
                               'http://newxk.urp.seu.edu.cn/xsxkapp/sys/xsxkapp/*default/grablessons.do?token=' + str(
                                   login_token))
            header6.setdefault('token', login_token)
            ...
            if display_flag_sports == 1:
                root.event_generate("<<UPDATE_SPORTS_LIST>>")
                display_flag_sports = 0
...
def update_institute(args):
    ...
    for i in range(0, list_recommend.__len__()):
        ...
        data = str(list_recommend[i]['courseName']) + " " + str(list_recommend[i]['teacherName']) + " " + str(
            list_recommend[i]['teachingPlace'])
...
def update_humanity(args):
    ...
    for i in range(0, list_humanity.__len__()):
        ...
        data = str(list_humanity[i]['courseName']) + " " + str(list_humanity[i]['teacherName']) + " " + str(
            list_humanity[i]['teachingPlace'])
...
def update_science(args):
    ...
    for i in range(0, list_science.__len__()):
        data = str(list_science[i]['courseName']) + " " + str(list_science[i]['teacherName']) + " " + str(
            list_science[i]['teachingPlace'])
...
def update_economy(args):
    ...
    for i in range(0, list_economics.__len__()):
        data = str(list_economics[i]['courseName']) + " " + str(list_economics[i]['teacherName']) + " " + str(
            list_economics[i]['teachingPlace'])
...
def update_sports(args):
    ...
    for i in range(0, list_sports.__len__()):
        data = str(list_sports[i]['courseName']) + " " + str(list_sports[i]['teacherName']) + " " + str(
            list_sports[i]['teachingPlace'])
...
def about():
    ...
    Button(dialog, text=' 移步GitHub',
           command=lambda: click_about("https://github.com/AriaPokotengYe/SEU-NewSystem-catcher")).pack(pady=5)
        ...
        if typo == 0:
            ...
            for i in range(0, current_list.__len__()):
                for j in range(0, current_list_selecting.__len__()):
                    if current_list[i]['teachingClassID'] in current_list_selecting and current_list[i][
                            'isFull'] == '0' and current_list[i]['isConflict'] == '0':
                        data = str(current_list[i]['courseName']) + " " + str(
                            current_list[i]['teacherName']) + " " + str(current_list[i]['teachingPlace'])
                        do_volunteer(current_list[i]['teachingClassID'], 'TJKC', typo, data)
            ...
            for i in range(0, current_list.__len__()):
                for j in range(0, current_list_selecting.__len__()):
                    if current_list[i]['teachingClassID'] in current_list_selecting and current_list[i][
                        ...
                        data = str(current_list[i]['courseName']) + " " + str(
                            current_list[i]['teacherName']) + " " + str(current_list[i]['teachingPlace'])
                        do_volunteer(current_list[i]['teachingClassID'], 'XGXK', typo, data)
                        if data not in list_running:
                            listbox6.insert(END, data)
                            print(data)
                            list_running.append(data)
            ...
            for i in range(0, current_list.__len__()):
                for j in range(0, current_list_selecting.__len__()):
                    if current_list[i]['teachingClassID'] in current_list_selecting and current_list[i][
                        ...
                        data = str(current_list[i]['courseName']) + " " + str(
                            current_list[i]['teacherName']) + " " + str(current_list[i]['teachingPlace'])
                        do_volunteer(current_list[i]['teachingClassID'], 'TYKC', typo, data)
                        if data not in list_running:
                            listbox6.insert(END, data)
                            print(data)
                            list_running.append(data)
...
def catch_specific():
    ...
    if index_tab == 0:
        ...
        if recommend_thread_working == 1:
            ...
            data = str(list_recommend[selected - 1]['courseName']) + " " + str(
                list_recommend[selected - 1]['teacherName']) + " " + str(list_recommend[selected - 1]['teachingPlace'])
            thread_recommend = threading.Thread(target=select_worker,
                                                args=(0, list_recommend_selecting, list_recommend))
    ...
    if index_tab == 1:
        ...
        if humanity_thread_working == 1:
            ...
            data = str(list_humanity[selected - 1]['courseName']) + " " + str(
                list_humanity[selected - 1]['teacherName']) + " " + str(list_humanity[selected - 1]['teachingPlace'])
    ...
    if index_tab == 2:
        ...
        if science_thread_working == 1:
            ...
            data = str(list_science[selected - 1]['courseName']) + " " + str(
                list_science[selected - 1]['teacherName']) + " " + str(list_science[selected - 1]['teachingPlace'])
    ...
    if index_tab == 3:
        ...
        if economics_thread_working == 1:
            ...
            data = str(list_economics[selected - 1]['courseName']) + " " + str(
                list_economics[selected - 1]['teacherName']) + " " + str(list_economics[selected - 1]['teachingPlace'])
            thread_economics = threading.Thread(target=select_worker,
                                                args=(3, list_economics_selecting, list_economics))
    ...
    if index_tab == 4:
        ...
        if sports_thread_working == 1:
            ...
            data = str(list_sports[selected - 1]['courseName']) + " " + str(
                list_sports[selected - 1]['teacherName']) + " " + str(list_sports[selected - 1]['teachingPlace'])
...
def do_volunteer(teachingClassId, teachingClassType, typo, data):
    global username
    global electiveBatchCode
    global headerNum
    global login_token
    ...
    header.setdefault('Referer',
                      'http://newxk.urp.seu.edu.cn/xsxkapp/sys/xsxkapp/*default/grablessons.do?token=' + str(
                          login_token))
    header.setdefault('token', login_token)
...
def check_course_list():
    ...
    dialog = Toplevel(root)
    dialog.title('课表')
    Button(dialog, text=' 查看课表 ', command=lambda: webbrowser.open_new(
        r"http://newxk.urp.seu.edu.cn//xsxkapp/sys/xsxkapp/*default/curriculum.do").pack(pady=5))
...
if __name__ == "__main__":
    ...
    root.bind("<<UPDATE_HUMANITY_LIST>>", update_humanity)
